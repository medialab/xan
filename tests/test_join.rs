...
#[test]
fn join_regex() {
    let wrk = Workdir::new("join_regex");
    wrk.create(
        "people.csv",
        vec![
            svec!["pattern", "name"],
...
#[test]
fn join_regex_multiselect() {
    let wrk = Workdir::new("join_regex_multiselect");
    wrk.create(
        "people.csv",
        vec![
            svec!["pattern", "name"],
...
#[test]
fn join_regex_ignore_case() {
    let wrk = Workdir::new("join_regex_ignore_case");
    wrk.create(
        "people.csv",
        vec![
            svec!["pattern", "name"],
