...
- **chr**(*int*) -> `string`: Return the unicode code point represented by given integer as a single character.
...
- **ord**(*string*) -> `int`: Return the integer representing the given unicode code point as a single character.
